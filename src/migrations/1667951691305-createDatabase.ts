...
export class createDatabase1667951691305 implements MigrationInterface {
    name = 'createDatabase1667951691305'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "classes" ADD CONSTRAINT "FK_08486e3f0fccc870023753db07e" FOREIGN KEY ("moduleId") REFERENCES "modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
